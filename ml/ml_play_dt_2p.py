"""
Decision-tree based MLPlay for 2P. Loads model from ml/models/dt_2p.joblib
"""
import os
import joblib
import pandas as pd
...
MODEL_PATH = os.path.join(os.path.dirname(__file__), 'models', 'dt_2p.joblib')
...
class MLPlay:
    ...
    def update(self, scene_info, *args, **kwargs):
        ...
        if len(self.history) >= 1:
            ...
            p1x_, p1y_ = s1['platform_1P']
            p2x_, p2y_ = s1['platform_2P']
            prev1_ball_vx = pvx
            prev1_ball_vy = pvy
        ...
        if len(self.history) >= 2:
            ...
            p1x2, p1y2 = s2['platform_1P']
            p2x2, p2y2 = s2['platform_2P']
            prev2_ball_vx = pvx2
            prev2_ball_vy = pvy2
